...
const ContactMe = () => {
    ...
    const [state, handleSubmit] = useForm("meqwzkwb");
                            ...
                            <article className="contact__option">
                                <Row>
                                    ...
                                    <Col xs={{ span: 12, order: 2 }} lg={5}>
                                        <h4>Email</h4>
                                        <h5>almoglevi71@gmail.com</h5>
                                        <a href="mailto:almoglevi71@gmail.com" target="_blank">Send an email</a>
                                    </Col>
                                </Row>
                            </article>
                            ...
                            <article className="contact__option">
                                <Row>
                                    ...
                                    <Col xs={{ span: 12, order: 1 }} lg={5}>
                                        <h4>WhatsApp</h4>
                                        <h5>052-7868810</h5>
                                        <a href="https://wa.me/972527868810" target="_blank">Send a message</a>
                                    </Col>
                                </Row>
                            </article>
